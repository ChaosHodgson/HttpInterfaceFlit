...
<link rel="stylesheet"
	href="${ctx}/static/bootstrap-3.3.6-dist/css/bootstrap.min.css"></link>
<style type="text/css">
.wrapx {
	...
	<div id="ntp-contents" class="wrapx">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form <%--action="request"--%> method="post" id="flitForm">
...
<script src="${ctx}/static/bootstrap-3.3.6-dist/js/jquery-2.2.2.min.js"></script>
<script src="${ctx}/static/bootstrap-3.3.6-dist/js/bootstrap.min.js"></script>
